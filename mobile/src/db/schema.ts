// Auto-mirrored from /database/schema.sql — keep both files in sync.
// This is the single schema applied on first launch via db/database.ts.
export const SCHEMA_SQL = `-- ROCK ARCHIVE PRO — Canonical SQLite schema
